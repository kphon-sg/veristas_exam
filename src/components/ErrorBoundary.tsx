      ...
      return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
          <div className="bg-white border border-slate-200 rounded-3xl p-10 max-w-md w-full text-center shadow-xl">
            ...
            <div className="bg-slate-50 rounded-xl p-4 mb-8 text-left overflow-hidden border border-slate-100">
              <p className="text-[10px] font-mono text-rose-500 break-all uppercase tracking-widest mb-2 font-bold">Error Details</p>
