        ...
        {isOpen && (
          ...
          >
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between mb-0.5">
                            <h4 className="text-sm font-bold text-slate-800 truncate">{notification.title}</h4>
                          ...
                          {!notification.isRead && (notification.type === 'INVITATION' || notification.type === 'JOIN_REQUEST') && (
                            <div className="flex items-center gap-2">
                              ...
                              <button 
                                ...
                                disabled={loading}
                                className="flex-1 py-1.5 bg-white border border-slate-200 text-slate-500 hover:bg-slate-50 text-[10px] font-black uppercase tracking-widest rounded-md transition-all flex items-center justify-center gap-1.5"
                              >
            ...
            <div className="p-3 bg-slate-50 border-t border-slate-100 text-center">
              <button className="text-[10px] font-black text-slate-400 uppercase tracking-widest hover:text-slate-600 transition-colors flex items-center justify-center gap-1 mx-auto">
